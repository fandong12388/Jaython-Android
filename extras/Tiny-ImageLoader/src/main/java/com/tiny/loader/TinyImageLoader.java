...
import com.tiny.loader.core.display.CircleRingBlurBitmapDisplayer;
...
public class TinyImageLoader {
    ...
    //带环模糊
    public static final int DISPLAY_CIRCLE_RING_BLUR = 16;
        ...
        private DisplayImageOptions build() {
            ...
            switch (this.mDisplayType) {
                ...
                case DISPLAY_CIRCLE_RING:// 圆形带环
                    ...
                    break;
                case DISPLAY_CIRCLE_RING_BLUR:// 圆形带环模糊
                    displayImageOptions = builder.displayer(
                            new CircleRingBlurBitmapDisplayer().setDepth(mBlurDepth).setStrokeWidth(mStrokeWidth).setColor(mRingColor)
                                    .setRingPadding(mRingPadding)).build();
                    break;
