...
public class ViewUtils {
    ...
    public static void showImage(ImageView imageView, String imgUrl) {
        showImage(imageView, imgUrl, TinyImageLoader.DISPLAY_DEFAULT);
    }
    ...
    public static void preLoadImage(String imgUrl) {
        TinyImageLoader.create(imgUrl).setDisplayType(TinyImageLoader.DISPLAY_DEFAULT);
    }
