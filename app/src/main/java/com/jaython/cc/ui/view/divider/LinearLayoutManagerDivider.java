...
public class LinearLayoutManagerDivider extends RecyclerView.ItemDecoration {
    ...
    private int mMaxLast = 1;

    public LinearLayoutManagerDivider(Context context, int orientation,
                                      @DrawableRes int drawableRes) {
        mDivider = context.getResources().getDrawable(drawableRes);
        setOrientation(orientation);
    }

    public LinearLayoutManagerDivider(Context context, int orientation, Drawable divider) {
        mDivider = divider;
        setOrientation(orientation);
    }
    ...
    public void drawVertical(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount - mMaxLast; i++) {
