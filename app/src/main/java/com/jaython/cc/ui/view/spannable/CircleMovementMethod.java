...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod() {
        this.textViewBgColor = gContext.getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = gContext.getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
    ...
    public CircleMovementMethod(int clickableSpanBgColor) {
        this.clickableSpanBgClor = clickableSpanBgColor;
        this.textViewBgColor = gContext.getResources().getColor(DEFAULT_COLOR_ID);
    }
